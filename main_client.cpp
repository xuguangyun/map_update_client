...
int main(int argc, char **argv)
{
     ...
     ros::init(argc, argv, "node_client");	//初始化ROS，节点命名为node_b，节点名必须唯一。
     std::string dir="/root/workspace/carto_client/configuration_files/";
     std::string name="option_client.lua";
